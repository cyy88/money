package com.cyy.mybatis.generator.plugin;
...
//        root.addImportedType(model + "." + queryVoName);
        ...
        root.addImportedType("com.cyy.mybatis.help.DbField");
        root.addImportedType("com.cyy.mybatis.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.cyy.mybatis.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.cyy.mybatis.help.FieldResult"));
